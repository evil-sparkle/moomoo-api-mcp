...
class TestRememberedToken:
    ...
    # user may not stat. Python 3.12 raises PermissionError there where 3.13+
    # answers False, so on the image's interpreter an unreadable directory
    # crashed the supervisor at startup instead of reading as "no account".
    @pytest.mark.skipif(
