# account-tools Specification

## Purpose

Provides simplified account tools by removing positional indexing (`acc_index`) in favor of explicit account identifiers and providing unified account summary aggregation.
