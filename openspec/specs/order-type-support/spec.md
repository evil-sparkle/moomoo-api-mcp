# order-type-support Specification

## Purpose

Defines supported order types (e.g., NORMAL, MARKET, STOP, STOP_LIMIT, TRAILING_STOP) across stock and option trading interfaces.
