# market-snapshot Specification

## Purpose

Provides lightweight multi-symbol market snapshot querying for bulk price and performance monitoring without establishing active stream subscriptions.
